# ---- This is <1_query_and_download_4_large_overview.py> ----

"""
Query CDSE for Sentinel-1 products for the MIZ voyage.
Search location is defined as broad polygon (./ROIS/large_ROI.geojson) to get a larger overview.
...
# Define ROI file
roi_geojson_path = pathlib.Path("./ROIS/large_ROI.geojson").resolve()
...
# ---- End of <1_query_and_download_4_large_overview.py> ----
